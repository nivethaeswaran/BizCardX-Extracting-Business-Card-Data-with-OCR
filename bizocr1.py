...
icon = Image.open("D:\phcharm icons\icon.png")
st.set_page_config(page_title="BizCardX: Extracting Business Card Data with OCR | By NIVETHA ESWARAN",
                   page_icon=icon,
                   layout="wide",
                   initial_sidebar_state="expanded",
                   menu_items={'About': """# This OCR app is created by *NIVETHA ESWARAN*!"""})
...
def setting_bg():
    st.markdown(f""" <style>.stApp {{
                        background:url("https://cutewallpaper.org/21x/hianxltb9/90-Simple-Backgrounds-Edit-and-Download-Visual-Learning-.jpg");
...
if selected == "Home":
    ...
    with col1:
        st.image(Image.open("D:\phcharm icons\icon.png"), width=500)
